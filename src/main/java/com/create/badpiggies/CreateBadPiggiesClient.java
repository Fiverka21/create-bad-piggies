...
@EventBusSubscriber(modid = CreateBadPiggies.MODID, value = Dist.CLIENT)
public class CreateBadPiggiesClient {
    public CreateBadPiggiesClient(ModContainer container) {
